class GossipformController < ApplicationController
    ...
    def create
        @gossipform = Gossip.new(gossip_params) # avec xxx qui sont les données obtenues à partir du formulaire

        if @gossip.save # essaie de sauvegarder en base @gossip
            redirect_to @gossip# si ça marche, il redirige vers la page d'index du site
        else
